...
create subscription phen_subscription 
...
create subscription unit_subscription 
connection 'host=db1 port=5432 dbname=weatherdb user=dis-db-user' 
...
create view station_all as 
    select *, 'Sweden' as country from station_local
...
create view device_all as
    select *, 'Sweden' as country from device_local
...
create view measurement_all as
    select *, 'Sweden' as country from measurement_local
